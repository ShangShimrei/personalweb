      ...
      <div className="w-full max-w-8xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {AI_MODELS.map((model, index) => (
            <div 
              key={model.id} 
              className={`bg-white border border-zinc-200 p-6 spring-hover hover:shadow-2xl hover:-translate-y-2 group reveal stagger-${(index % 3) + 1} rounded-none flex flex-col`}
            >
