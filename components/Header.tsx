  ...
  return (
    ...
    >
      <div className="w-full max-w-8xl mx-auto flex justify-between items-center relative">
        ...
        {/* Desktop Nav - Hidden on Tablet (md/lg) and Mobile, Visible on Extra Large Screens (xl) */}
        ...
        {/* Mobile/Tablet Menu Toggle - Visible on Tablet and Mobile (up to lg) */}
        <button 
        ...
        >
          {/* Inner container handles vertical centering and ensures scrolling works in landscape */}
